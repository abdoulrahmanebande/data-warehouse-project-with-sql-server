...
Script Turpose:
  ...
  to populate the 'silver' schema tables from the 'bronze' schema.
	...
	- Inserts, tranforms, and cleans data from Bronze into Silver tables.
...
BEGIN TRY
	...
	print('Load duration of Silver layer: ' + CAST(DATEDIFF(millisecond, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' milliseconds.');
END TRY
BEGIN CATCH
